...
namespace ClientImport.Models.ClientModels.Client.MonroeCountySchoolBoard
{
    public class Repository : BaseRepository<Record>
    {
        ...
        public Repository() : base(Constants.Clients.MonroeCountySchoolBoard, Constants.ConfigMonroeCountySchoolBoardFileSource, Constants.ConfigMonroeCountySchoolBoardFileExt)
        { }
