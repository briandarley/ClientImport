...
namespace Archived.ClientImport.Models.ClientModels.Client.PolkCountySchoolBoard
{
    public class Repository : BaseRepository<Record>
    {
        ...
        public Repository() : base(Constants.Clients.PolkCountySchoolBoard, Constants.ConfigPolkCountySchoolBoardFileSource, Constants.ConfigPolkCountySchoolBoardFileExt)
        { }
        ...
        protected override IEnumerable<IRecord<Record>> ReadSourceFileRecords(string filePath)
        {
            ...
            {
                _logger.LogError(Constants.Clients.PolkCountySchoolBoard, ex);
