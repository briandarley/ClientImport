...
namespace Archived.ClientImport.Models.ClientModels.Client.MiamiJewish
{
                    ...
                    .ForMember(target => target.ZipCode, opts => opts.ResolveUsing(c => c.ZipCode))
                     .AfterMap((src, target) =>
                     {
                         ...
                         if (!src.DepartmentName.IsEmpty())
                         {
                             ...
                             tierMapping.MapOrgLevel(Tiers4, 4, src.DepartmentName.ToUpper(), src.DepartmentName.ToUpper(),
