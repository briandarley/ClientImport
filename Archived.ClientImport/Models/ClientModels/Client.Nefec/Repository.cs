...
namespace Archived.ClientImport.Models.ClientModels.Client.Nefec
{
    public class Repository : BaseRepository<Record>
    {
        ...
        public Repository() : base(Constants.Clients.Nefec, Constants.ConfigNefecFileSource, Constants.ConfigNefecFileExt)
        { }
